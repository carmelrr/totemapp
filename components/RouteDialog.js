        ...
        <ScrollView style={styles.content}>
          ...
          {user && (
            <View style={styles.feedbackForm}>
              ...
              <View style={styles.formGroup}>
                <TouchableOpacity
                  style={[styles.checkboxContainer, closedRoute && styles.checkboxSelected]}
              ...
              >
                <Text style={styles.submitButtonText}>
                  {isSubmitting ? 'שולח...' : (userFeedback ? 'עדכן פידבק' : 'שלח פידבק')}
                </Text>
              </TouchableOpacity>
            </View>
          )}
          ...
          <View style={styles.feedbacksList}>
            <Text style={styles.feedbacksTitle}>פידבקים ({feedbacks.length})</Text>
            {feedbacks.length === 0 ? (
              <Text style={styles.noFeedbacks}>עדיין אין פידבקים למסלול זה</Text>
            ) : (
                ...
                return (
                  <View key={feedback.id} style={styles.feedbackItem}>
                    <View style={styles.feedbackHeader}>
                      ...
                      <Text style={styles.feedbackDate}>{formatDate(feedback.submittedAt)}</Text>
                      {isAdmin && (
                        <TouchableOpacity
                  ...
                  <View style={styles.feedbackContent}>
                    <View style={styles.feedbackRatings}>
                      <StarRating rating={feedback.starRating || 0} disabled={true} />
                      <Text style={styles.feedbackGrade}>דירוג מוצע: {feedback.suggestedGrade}</Text>
