...
try {
  ...
  console.log('   - GestureHandlerRootView:', typeof GestureHandler.GestureHandlerRootView);
} catch (e) {
...
console.log('\n📋 Summary:');
console.log('All required dependencies for RobustCropper4x3 should be available.');
console.log('If you see any ❌ errors above, run: npx expo install [package-name]');
