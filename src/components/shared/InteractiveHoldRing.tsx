...
export interface InteractiveHoldRingProps {
    hold: {
 ...
 * Supports pan, pinch, and resize gestures
 */
const InteractiveHoldRing = ({
    hold,
    imageWidth,
    imageHeight,
    isSelected = false,
    ...
    const animatedProps = useAnimatedProps(() => ({
        cx: externalRadius ? externalRadius.value : currentRadiusShared.value,
        cy: externalRadius ? externalRadius.value : currentRadiusShared.value,
...
export default memo(InteractiveHoldRing);
