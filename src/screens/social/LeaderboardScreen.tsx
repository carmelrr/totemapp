...
export default function LeaderboardScreen() {
  ...
  const getRestOfUsers = () => {
    ...
    if (currentUser && currentUserRank && currentUserRank > 13 && currentUser.points > 0) {
      restUsers.push({
        ...currentUser,
        ...
        <View style={styles.podiumRow}>
          ...
          {topThree[1] && (
            <View style={styles.podiumPlace}>
              ...
              <Image 
                source={topThree[1].photoURL ? { uri: topThree[1].photoURL } : defaultAvatar} 
          ...
          {topThree[0] && (
            <View style={styles.podiumPlace}>
              ...
              <Image 
                source={topThree[0].photoURL ? { uri: topThree[0].photoURL } : defaultAvatar} 
                style={styles.podiumAvatar}
              />
          ...
          {topThree[2] && (
            <View style={styles.podiumPlace}>
              ...
              <Image 
                source={topThree[2].photoURL ? { uri: topThree[2].photoURL } : defaultAvatar} 
                style={styles.podiumAvatar}
              />
      ...
      >
        ...
        <View style={styles.listSection}>
          ...
          {getRestOfUsers().map((user, index) => {
            const displayIndex = user.actualRank ? user.actualRank - 1 : index + 3; // For the renderLeaderboardItem
            return (
              <View key={user.id}>
