...
export default function AdminWallSetupScreen() {
  ...
  const selectImage = async () => {
    ...
    const testImageUrl =
      "https://res.cloudinary.com/dfpkhezq6/image/upload/v1754052283/walls/test_wall.jpg";
  ...
  const onImageLoad = (event) => {
    ...
    console.log("Admin setup - Image loaded:", {
      imgWidth,
      imgHeight,
      displayWidth,
      displayHeight,
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity
          style={[
            styles.saveButton,
            (!selectedImage || holds.length < 10) && styles.saveButtonDisabled,
          ]}
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.instructions}>
          <Text style={styles.instructionText}>
            👆 לחץ לבחירת תמונה • 🎯 לחץ על התמונה לסימון אחיזות • ❌ לחץ על
            אחיזה למחיקה
          </Text>
        </View>
