...
// screens/SprayWall/SprayWallMapViewScreen.tsx
...
interface SprayWallMapViewScreenProps {
  route: {
    params: {
      wallId?: string;
    };
...
/**
 * מסך תצוגת מפת קיר הספריי - כלי ציור וניווט בקיר
 * SprayWall Map View Screen - drawing tools and wall navigation interface
 */
export const SprayWallMapViewScreen: React.FC<SprayWallMapViewScreenProps> = ({
  route,
  navigation,
}) => {
  ...
  const handleMenuPress = () => {
    ...
    Alert.alert("אפשרויות", "בחר פעולה", [
  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <FloatingPanel position="top-left">
        <ToolButton title="חזור" icon="◀" onPress={handleBackPress} />
      </FloatingPanel>

      <FloatingPanel position="top-right">
        <ToolButton title="תפריט" icon="☰" onPress={handleMenuPress} />
      </FloatingPanel>
...
export default SprayWallMapViewScreen;
