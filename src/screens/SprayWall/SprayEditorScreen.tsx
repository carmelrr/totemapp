...
const SprayEditorScreen = ({ navigation, route }) => {
  ...
  useEffect(() => {
    console.log("SharedValues update effect:", {
      isEditing,
        ...
        {holds.map((hold, index) => {
          return (
            <SprayHoldRing
              ...
              externalTranslateX={
                isEditing && index === selectedHoldIndex
                  ? selectedTranslateX
                  : undefined
              }
              externalTranslateY={
      ...
      >
        <SafeAreaView style={styles.modalContainer}>
          <View style={styles.modalHeader}>
            ...
            <TouchableOpacity onPress={handleSaveRoute} disabled={saving}>
