...
// screens/SprayWall/SprayWallEditorScreen.tsx
...
interface SprayWallEditorScreenProps {
  route: {
    params: {
      wallId?: string;
    };
 ...
 */
export const SprayWallEditorScreen: React.FC<SprayWallEditorScreenProps> = ({
  route,
  navigation,
}) => {
...
export default SprayWallEditorScreen;
