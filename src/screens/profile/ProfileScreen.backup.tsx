...
export default function ProfileScreen() {
  ...
  const handleSave = async () => {
    try {
      ...
      try {
        ...
        console.error(
          "Migration failed but profile was saved:",
          migrationError,
        );
      }
  ...
  const avatarSource =
    photoURL && photoURL.trim() !== "" ? { uri: photoURL } : defaultAvatar;
  ...
  const GradeStatsModal = () => {
    ...
    const totalCompleted = Object.values(gradeStats).reduce(
      (sum, stat: any) => sum + (stat?.completed || 0),
      0,
    );
    const overallPercentage =
      totalRoutes > 0
        ? ((Number(totalCompleted) / totalRoutes) * 100).toFixed(1)
        : "0.0";
        ...
        <View style={styles.modalContainer}>
          ...
          <View style={styles.overallStatsContainer}>
            <Text style={styles.overallStatsText}>
              סיכום כללי: {String(totalCompleted)} מתוך {totalRoutes} מסלולים (
              {overallPercentage}%)
            </Text>
          </View>
      ...
      <View style={styles.statsContainer}>
        ...
        <View style={styles.statsGrid}>
          ...
          <StatCard
            ...
            color="#8e44ad"
            onPress={
              privacySettings.showGradeStats
        ...
        {userStats.joinDate &&
          (privacySettings.showJoinDate || isEditingPrivacy) && (
            <View style={styles.joinDateContainer}>
              <View style={styles.joinDateContent}>
                <Text style={styles.joinDateText}>
                  🗓️ חבר מאז:{" "}
                  {privacySettings.showJoinDate
                    ? userStats.joinDate.toLocaleDateString("he-IL")
                    : "פרטי"}
                </Text>
                {isEditingPrivacy && (
        ...
        <View style={styles.socialSection}>
          ...
          <View style={styles.socialTabs}>
            <TouchableOpacity
              style={[
                styles.socialTab,
                socialActiveTab === "search" && styles.activeSocialTab,
              ]}
            ...
            >
              <Text
                style={[
                  ...
                  socialActiveTab === "search" && styles.activeSocialTabText,
                ]}
              >
                חיפוש
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.socialTab,
                socialActiveTab === "following" && styles.activeSocialTab,
              ]}
            ...
            >
              <Text
                style={[
                  styles.socialTabText,
                  socialActiveTab === "following" && styles.activeSocialTabText,
                ]}
              >
            ...
            <TouchableOpacity
              style={[
                styles.socialTab,
                socialActiveTab === "followers" && styles.activeSocialTab,
              ]}
            ...
            >
              <Text
                style={[
                  styles.socialTabText,
                  socialActiveTab === "followers" && styles.activeSocialTabText,
                ]}
              >
                  ...
                  {searchResults.map((item) => (
                    <View key={item.id} style={styles.userItem}>
                      ...
                      <TouchableOpacity
                        style={[
                          styles.followButton,
                          isUserFollowed(item.id) && styles.unfollowButton,
                        ]}
                        onPress={() =>
                          handleFollowToggle(item.id, isUserFollowed(item.id))
                        }
                      >
                        <Text
                          style={[
                  ...
                  <View style={styles.circleSizeRowContent}>
                    <Text
                      style={[
                        ...
                        circleSize === option.size &&
                          styles.circleSizeRowLabelSelected,
                      ]}
                    >
                      {option.label}
                    </Text>
                    <View
                      style={[
                        styles.circleSizeRowPreview,
                        {
                          ...
                          backgroundColor:
                            circleSize === option.size ? "#667eea" : "#bdc3c7",
                        },
                      ]}
                    >
                      <Text
