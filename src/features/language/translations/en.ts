...
export const en = {
  ...
  admin: {
    ...
    classPlanner: "Class Planning",
  },

  // Class Planning
  classes: {
    title: "Class Planning",
    subtitle: "Operational + economic simulator for groups, locations and profitability",
    settings: "Settings",
    locations: "Locations",
    programs: "Programs",
    groups: "Groups",
    ...
    program: "Pricing Track",
    participantsCount: "Participants",
    capacity: "Capacity",
    monthlyPrice: "Monthly Price per Child",
    sessionsPerWeek: "Sessions per Week",
    sessionDuration: "Session Duration (hours)",
    coachName: "Coach",
    coachHourlyRate: "Coach Hourly Rate",
    assistantEnabled: "Assistant Coach",
    assistantHourlyRate: "Assistant Hourly Rate",
    assistantHoursPerWeek: "Assistant Hours / Week",
    requiredLocationType: "Required Location Type",
    requiredWallMeters: "Required Wall Meters",
    notes: "Notes",
    // Location form
    locationName: "Location Name",
    locationType: "Location Type",
    lengthMeters: "Length (m)",
    usableLengthMeters: "Usable Length (m)",
    maxParallelGroups: "Max Parallel Groups",
    allowedGroupTypes: "Allowed Group Types",
    active: "Active",
    locationTypeWall: "Wall",
    locationTypeKidsArea: "Kids Area",
    locationTypeTrainingArea: "Training Area",
    locationTypeOther: "Other",
    // Settings
    weeksPerMonth: "Weeks per Month",
    employerCostMultiplier: "Employer Cost Multiplier",
    defaultMetersPerParticipant: "Default Meters per Participant",
    displayStart: "Board Start Hour",
    displayEnd: "Board End Hour",
    slotMinutes: "Slot Resolution (min)",
    kidsMinPerGroup: "Kids Min per Group",
    kidsMaxPerGroup: "Kids Max per Group",
    targetMargin: "Target Margin (%)",
    // Dashboard
    dashboard: "Dashboard",
    totalGroups: "Total Groups",
    totalWeeklySessions: "Weekly Sessions",
    totalParticipants: "Total Participants",
    monthlyRevenue: "Monthly Revenue",
    coachCost: "Coach Cost",
    assistantCost: "Assistant Cost",
    grossProfit: "Gross Monthly Profit",
    overallMargin: "Overall Margin",
    weeklyWallHours: "Weekly Wall Hours",
    weeklyKidsHours: "Weekly Kids-Area Hours",
    profitPerWallHour: "Profit per Wall Hour",
    peakConcurrent: "Peak Concurrent Groups",
    peakUtilization: "Peak Wall Utilization",
    losingGroups: "Losing Groups",
    belowBreakEven: "Below Break-Even",
    availableSeats: "Available Seats",
    capacityViolations: "Capacity Violations",
    activeAlerts: "Active Alerts",
    breakEvenParticipants: "Break-Even Participants",
    monthlyProfit: "Monthly Profit",
    profitPerSession: "Profit per Session",
    margin: "Margin",
    // Views
    viewSchedule: "Schedule",
    viewUtilization: "Wall Load",
    viewProfitability: "Profitability",
    viewAlerts: "Alerts",
    // Alerts
    alertExceedsParallelCapacity: (loc: string) => `Parallel capacity exceeded at ${loc}`,
    alertExceedsWallLength: (loc: string) => `Wall length exceeded at ${loc}`,
    alertKidsNotInKidsArea: (group: string) => `Kids group "${group}" placed on a wall instead of the kids area`,
    alertRegularInKidsArea: (group: string) => `Group "${group}" placed in kids area but is not a kids group`,
    alertDisallowedGroupType: (group: string, loc: string) => `Group type "${group}" is not allowed at ${loc}`,
    alertCoachDoubleBooked: (coach: string) => `Coach ${coach} is booked for two groups at the same time`,
    alertSessionInvalidTimes: "End time is earlier than start time",
    alertKidsBelowMinimum: (group: string) => `Group "${group}": below minimum kids`,
    alertKidsAboveMaximum: (group: string) => `Group "${group}": above maximum kids`,
    alertBelowBreakEven: (group: string) => `Group "${group}" is below break-even`,
    noAlerts: "No alerts 🎉",
    // Empty states
    noGroupsYet: "No groups yet",
    noLocationsYet: "Set up locations first in Settings",
  ...
  competitionExt: {
    ...
    nationalLeagueToggle: "Used as a national league",
    nationalLeagueHint: "Registrants must enter full name, ID number, birth year and gender.",
    fullNameLabel: "Full Name",
    fullNamePlaceholder: "First and last name",
    idNumberLabel: "ID Number",
    idNumberPlaceholder: "9 digits",
    mustEnterFullName: "Please enter your full name",
    mustEnterIdNumber: "Please enter a valid ID number",
